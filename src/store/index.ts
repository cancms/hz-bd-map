...
export const useGlobalStore = defineStore({
	...
	actions: {
		...
		setCountryCardData() {
			...
			this.countryCardData.cardData.push(addCardData(chinaTotal, '累计', 'confirm', '#a31d34'))
		...
		setGuangDongCardData() {
			...
			this.guangdongCardData.cardData.push(addCardData(guangdongData, '累计', 'confirm', '#a31d34'))
